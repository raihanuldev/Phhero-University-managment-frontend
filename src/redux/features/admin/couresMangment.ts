...
export const {useAddCouresMutation,useAllSemesterRegistedQuery,useAddSemesterRegisterMutation,
  useUpdateSemesterRegisterMutation,useGetAllCouresQuery, useAddFacultiesMutation,useCreateOfferedCourseMutation
,useGetCourseFacultiesQuery} = academicMangmentApi;
